...
def _seed_badges(app: Flask):
    """Insert default badges if the table is empty."""
    ...
    defaults = [
        {"name": "Streak Starter", "description": "Maintain a daily streak of 1 day", "icon": "🔥", "badge_type": "streak", "threshold": 1},
        {"name": "Streak Master", "description": "Maintain a daily streak of 7 days", "icon": "⚡", "badge_type": "streak", "threshold": 7},
        {"name": "XP Novice", "description": "Earn 100 total XP", "icon": "⭐", "badge_type": "xp", "threshold": 100},
        {"name": "XP Expert", "description": "Earn 1000 total XP", "icon": "👑", "badge_type": "xp", "threshold": 1000},
        {"name": "Perfect Score", "description": "Get a perfect score on a test", "icon": "💯", "badge_type": "perfect_score", "threshold": 1},
    ]
    ...
    try:
        db.session.commit()
        app.logger.info("Seeded %d default badges.", len(defaults))
    except Exception as exc:
        db.session.rollback()
        app.logger.warning("Badge seed failed: %s", exc)
